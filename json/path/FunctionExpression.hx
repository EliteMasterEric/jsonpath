...
class FunctionExpression {
    static final VALID_FUNCTIONS:Array<String> = [
        "length",
        "count",
        "match",
        "search",
    ...
    static function evaluateFunction_length(arguments:Array<PrimitiveLiteral>):PrimitiveLiteral {
        if (arguments.length <= 0) throw 'Too few arguments for length(): ${arguments.length}';
        if (arguments.length >= 2) throw 'Too many arguments for length(): ${arguments.length}';
    ...
    static function evaluateFunction_count(arguments:Array<PrimitiveLiteral>):PrimitiveLiteral {
        if (arguments.length <= 0) throw 'Too few arguments for count() (expected a single array): ${arguments.length}';
        if (arguments.length >= 2) throw 'Too many arguments for count() (expected a single array): ${arguments.length}';
    ...
    static function evaluateFunction_match(arguments:Array<PrimitiveLiteral>):PrimitiveLiteral {
        if (arguments.length <= 1) throw 'Too few arguments for count() (expected a single array): ${arguments.length}';
        if (arguments.length >= 3) throw 'Too many arguments for count() (expected a single array): ${arguments.length}';
    ...
    static function evaluateFunction_value(arguments:Array<PrimitiveLiteral>):PrimitiveLiteral {
        if (arguments.length <= 0) throw 'Too few arguments for value(): ${arguments.length}';
        if (arguments.length >= 2) throw 'Too many arguments for value(): ${arguments.length}';
